...
class Player extends  SpriteAnimationGroupComponent with HasGameRef<PixelAdventure>,KeyboardHandler
{
  ...
  bool onKeyEvent(KeyEvent event, Set<LogicalKeyboardKey> keysPressed) {
    ...
    final ifLeftKeyPressed = keysPressed.contains(LogicalKeyboardKey.keyA) || keysPressed.contains(LogicalKeyboardKey.arrowLeft);
    final ifRightKeyPressed = keysPressed.contains(LogicalKeyboardKey.keyD) || keysPressed.contains(LogicalKeyboardKey.arrowRight);

    horizontalMovement += ifLeftKeyPressed ? -1 : 0;
    horizontalMovement += ifRightKeyPressed ? 1 : 0;
